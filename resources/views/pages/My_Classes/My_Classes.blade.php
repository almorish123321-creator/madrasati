                        ...
                        <tbody>
                            ...
                            @foreach ($List_Classes as $My_Class)
                                <tr>
                                    ...
                                    <td>
                                        {{-- أزرار التصدير --}}
                                        <a href="{{ route('students.export_class_pdf', $My_Class->id) }}"
                                           class="btn btn-secondary btn-sm" title="{{ trans('main_trans.export_class_pdf') }}"
                                           target="_blank">
                                            <i class="fas fa-file-pdf text-danger"></i>
                                        </a>
                                        <a href="{{ route('students.export_attendance_form', $My_Class->id) }}"
                                           class="btn btn-secondary btn-sm" title="{{ trans('main_trans.export_attendance_excel') }}">
                                            <i class="fas fa-file-excel text-success"></i>
                                        </a>
                                        <a href="{{ route('students.export_degrees_pdf', $My_Class->id) }}"
                                           class="btn btn-secondary btn-sm" title="{{ trans('main_trans.export_degrees_pdf') }}"
                                           target="_blank">
